...
gym.register(
    id="Tracking-Flat-G1-ProjGravAnchorObs-MotionAE-NMMLP-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point":
...
gym.register(
    id="Tracking-Flat-G1-ProjGravAnchorEEObs-NMMLP-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point":
...
gym.register(
    id="Tracking-Flat-G1-ProjGravAnchorObs-TransformerVAE-NMMLP-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point":
...
gym.register(
    id="Tracking-Flat-G1-ProjGravAnchorEEObs-TransformerVAE-NMMLP-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point":
...
gym.register(
    id="Tracking-Flat-G1-ProjGravAnchorEEObs-TransformerVAE-SplitBodyReward-NMMLP-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point":
...
gym.register(
    id="Tracking-Flat-G1-ProjGravAnchorEEObsOneStep-TransformerVAE-NMMLP-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point":
        flat_env_cfg.G1FlatProjGravAnchorEEObsOneStepTransformerVAEEnvCfg,
        "rsl_rl_cfg_entry_point":
        f"{agents.__name__}.rsl_rl_ppo_cfg:G1FlatPPOModNormRunnerCfg",
    },
)
...
gym.register(
    id="Tracking-Flat-G1-ProjGravAnchorEERelObsOneStep-TransformerVAE-NMMLP-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point":
        flat_env_cfg.G1FlatProjGravAnchorEERelObsOneStepTransformerVAEEnvCfg,
        "rsl_rl_cfg_entry_point":
        f"{agents.__name__}.rsl_rl_ppo_cfg:G1FlatPPOModNormRunnerCfg",
    },
)
...
gym.register(
    id="Tracking-Flat-G1-ProjGravAnchorEEObs-DirectRefMotion-NMMLP-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point":
...
gym.register(
    id="Tracking-Flat-G1-ProjGravAnchorEEObsOneStep-DirectRefMotion-NMMLP-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point":
        flat_env_cfg.G1FlatProjGravAnchorEEObsOneStepDirectRefMotionEnvCfg,
        "rsl_rl_cfg_entry_point":
        f"{agents.__name__}.rsl_rl_ppo_cfg:G1FlatPPOModNormRunnerCfg",
    },
)
