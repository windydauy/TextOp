...
MOTION_ROOT="${MOTION_ROOT:-/home/humanoid/yzh/TextOp/trip_npz_filtered}"
NUM_ENVS="${NUM_ENVS:-8192}"
MAX_ITERATIONS="${MAX_ITERATIONS:-100000}"
DEVICE="${DEVICE:-cuda:0}"
RUN_NAME="${RUN_NAME:-motion_transformer_vae_zc_opti_filtered}"
EXPERIMENT_NAME="${EXPERIMENT_NAME:-motion_transformer_vae_zc_opti_filtered}"
