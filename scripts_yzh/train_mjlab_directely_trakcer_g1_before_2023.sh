...
RUN_NAME="${RUN_NAME:-mjlab_direct_g1_before_2023_no_motion_freeze_no_wrist_dr}"
EXPERIMENT_NAME="${EXPERIMENT_NAME:-mjlab_direct_g1_before_2023}"
WANDB_PROJECT="${WANDB_PROJECT:-MjlabTracker}"
TASK_NAME="${TASK_NAME:-Mjlab-LatentTracker-Flat-G1-ProjGravAnchorEEObs-DirectRefMotion}"
...
HYDRA_FULL_ERROR=1 python scripts/rsl_rl/train.py "${TASK_NAME}" \
  ...
  --env.commands.motion.motion-transformer-vae-enabled False \
